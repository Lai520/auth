  ...
  <mu-container class="container-my">
          ...
          <div class="flex column" style="max-width: 50%;">
            ...
            <div>
              ...
              <div>
                ...
                <div class="flex" style="color:rgba(0,0,0,.54);justify-content: space-between">
                  <div class="subtitle">{{$t('canBuy')}}</div>
                  <div class="subtitle">{{Number(user_legal).toFixed(2)}} USDT</div>
                </div>
                <div class="flex" style="color:rgba(0,0,0,.54);justify-content: space-between">
                  <div class="subtitle">{{$t('canSell')}}</div>
                  <div class="subtitle">{{Number(user_currency).toFixed(2)}} {{currency_name}}</div>
                </div>
              </div>
              ...
              <div>
                ...
                <div class="flex buy-sell-button">
                  <mu-button @click="buyCoin('buy')" class="mt10" color="success" full-width>
                    {{ $t('td.buyin1') }}
                  </mu-button>
                  <mu-button @click="buyCoin('sell')" class="mt10" color="error" full-width>
                    {{ $t('td.sellout1') }}
                  </mu-button>
                </div>
              </div>
              ...
              <div style="margin:10px;" v-for="item in dealIn">
                ...
                <span class="flex1" style="text-align: left">
                  <span class="bold" :class="item.direction==='buy'?'green':'red'"
                    ...
                    class="subtitle" style="font-style: normal;">{{ timeOffsetFn(item.create_time) }}</i>
                  </span>
                  <span>
            ...
            <div class="demo-text" v-if="active1 === 1">
              <div style="margin:10px;" v-for="item in dealCompleted">
                ...
                <span class="flex1" style="text-align: left">
                  <span class="bold" :class="item.direction==='buy'?'green':'red'"
                        style="font-size: 14px;">{{ item.direction === 'buy' ? $t('td.buy') : $t('td.sell') }}</span> <i
                    class="subtitle" style="font-style: normal;">{{ timeOffsetFn(item.time) }}</i>
                  </span>
                  <span>
                  </span>
                </div>
    ...
    <mu-dialog :title="$t('lay.confirm')" width="600" max-width="80%" :esc-press-close="false"
      ...
      <mu-button slot="actions" flat  :color="tradeMode === 'buy'?'green':'red'" @click="submit">{{
          tradeMode === 'buy' ? $t('td.buyin1') : $t('td.sellout1')
        }}
      </mu-button>
    </mu-dialog>
  </mu-container>
