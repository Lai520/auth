export default {
    "mockuser":"このアカウントはシミュレーションアカウントであり、この機能は使用できません",
    "username":"ユーザー名を入力してください",
    "bindBankCard":"銀行カードを結びつけてください",
    "canBuy":"こうにゅうかのう",
    "canSell":"売ることができる",
    "fundPwd":"資金パスワード",
    "pFundPwd":"資金番号を入力してください",
    "ppFundPwd":"個人センターで暗証番号を設定してください",
    "oldPwd":"古い暗号",
    "newPwd":"新しいパスワード",
    "surePwd":"新しいパスワードを確認する",
    "modifySuccess":"修正に成功する",
    "andKefu":"顧客サービスに連絡する",
    ...
    "transferOk": "振り替え完了",
    "customerRecharge":"カスタマーサービスに連絡してチャージする",
    "xieyi1": {
    ...
    "footer": {
        ...
        "wechat": "WeChat",
        "weibo": "微博",
        "email_info": "メールボックス：huobi@tokenomy.vip",
        "email_pre": "カスタマーサービス：",
        "address": "シンガポール© 2013-2020 Tokenomy",
        "email": "ビジネスメールアドレス",
        "feedback": "問題フィードバック",
        "about2": "会社の概要",
        "coin": "デジタル資産の紹介",
        "service": "サービス",
        "apply_url": "https://tokenomy.vip/dist/#/components/noticeDetail?id=197",
        "feedback_url": "https://tokenomy.vip/dist/#/components/noticeDetail?id=202",
        "about2_url": "https://tokenomy.vip/dist/#/components/noticeDetail?id=208",
        "coin_url": "https://tokenomy.vip/dist/#/components/noticeDetail?id=213",
        "yinsi_url": "https://tokenomy.vip/dist/#/components/noticeDetail?id=218",
        "feilv_url": "https://tokenomy.vip/dist/#/components/noticeDetail?id=223",
        "legal_url": "https://tokenomy.vip/dist/#/components/noticeDetail?id=228"
    },
    "home": {
        "with": "はい、",
        "myMarkets": "交易所",
        ...
        "atrade": "Tokenomyグローバルステーションのアカウントを登録して、取引の旅を開始します。",
        "Gcoin": "Tokenomy",
        ...
        "img2": "2_jp.png",
        "img3": "3_jp.png",
        "d1": "Tokenomy Global，24時間の出来高<b>{number}</b>ドル",
    ...
    "auth2": {
        ...
        "tip2": "証明書を持って撮った写真を提供してください。同じ写真にも「Tokenomy」と日付とサインのコメントが含まれています。顔がよく見えるようにしてください。証明書の詳細は全部分かります",
        "face": "顔がくっきりと見える",
        "clearly": "写真が鮮明に見える",
        "notes": "[Tokenomy]の文字コメントが付いています",
        ...
        "tip4": " ご本人のTokenomyアカウントの資産明細のスクリーンショットまたは写真を提供してください。画像にはお客様の口座名、uid、在庫保持の詳細、現在の時間が含まれています。すべての情報をクリアして読むことができます。",
    ...
    "account": {
        ...
        "desc1": "本チャージチャネルは暗号化された通貨の預金のみをサポートしています。あなたは自国通貨で預金します。必要であれば、オンラインカスタマーサービスに連絡して送金口座を取得してください"
    },
    "set": {
        "secset": "セキュリティ設定",
        "msgcer": "情報認証",
    ...
    "tpc": {
        ...
        "nodata": "データがありません",
        "search": "索",
        "tips": "*現在のページの展示内容はプロジェクト側自身で記入して、Tokenomyはこの内容の真実性に責任を負わない",
        "time": "発行時間",
        "total": "総発行量",
        "circulation": "トークンフロー",
        "price": "発行価格",
    ...
    "iepn": {
        ...
        "remindnum": "残りの数量",
        "hotcommond": "人気のおすすめ",
        "ctitle": "グローバルワクチン突然変異予防生態系",
        "cdsp": "新型コロナウイルス肺炎（VIF）を予防するワクチンの世界的な獲得は完全に分散した金融（DeFi）生態系であり、ブロックチェーンをインフラストラクチャとし、100%分散交換、100%自由取引、100%カスタム取引モデル、100%チェーン横断サポートである。私たちは事前に2つの取引モデル、VIF/BTCとVIF/USDTをカスタマイズしました。VIF/BTCは安定した切り上げ空間を持つ主流通貨である。VIF/USDTは安定した決済仮想通貨で、ドルと1:1で自由に両替できる。VIFは世界的なデジタル暗号化通貨の中心化市場へのリーダーである。",
        "starttime": "開始時間",
        "startprice": "開始価格",
        "endtime": "終了時間",
        "seemore": "詳細を表示",
        "baipishu": "テクニカルホワイトペーパー",
        "gobuy": "買いに行こう",
        "pstart": "プロジェクト開始時間",
        "pdoing": "プロジェクト購読",
        "pending": "購読が完了しました",
    ...
    "bank": {
        ...
        "other":"フリガナ",
        "branch": "支店番号",
        "realfirst": "まず実名を確認してください！",
        "realauing": "あなたの実名認証は審査中です！",
        "submit": "銀行カード情報のバインド",
        "reset": "リセット",
        "confirm": "銀行カード情報をバインドしたら、お客様に連絡して修正する必要があります。本当にバインドしますか。",
        "change": "変更のためにお客様に連絡する",
        "withdraw":"銀行に引き出す",
        "withdrawTip":"銀行カードに現金を引き出したい場合は、まず銀行カード情報をバインドしてください",
        "confirmwidthraw":"銀行カードに現金を預けることを確定しますか。",
        "binded":"銀行カードをバインドして、直接銀行カードに現金を引き出すことができます！",
