export default {
    "mockuser":"该账户为模拟账户，无法使用此功能",
    "username":"请输入用户名",
    "bindBankCard":"请去绑定银行卡",
    "canBuy":"可以买入",
    "canSell":"可以卖出",
    "fundPwd":"资金密码",
    "pFundPwd":"请输入资金密码",
    "ppFundPwd":"请前往个人中心设置资金密码",
    "oldPwd":"旧密码",
    "newPwd":"新密码",
    "surePwd":"确认新密码",
    "modifySuccess":"修改成功",
    ...
    "footer": {
        ...
        "email": "商务邮箱",
        "email_pre": "客服：",
        "email_info": "官方邮箱：huobi@tokenomy.vip",
        "feedback": "问题反馈",
        "address": "新加坡© 2013-2020 Tokenomy",
        "about2": "公司简介",
        "service": "服务",
        "coin": "数字资产介绍",
    ...
    "home": {
        ...
        "android": "Android",
        "pinput": "请输入你的邮箱",
        "atrade": "注册一个Tokenomy全球站账号 开始交易旅程",
        "Gcoin": "Tokenomy",
        "eamil1": "商务合作邮箱",
        "eamil2": "客服邮箱",
        "kefu": "在线客服",
    ...
    "auth2": {
        ...
        "back": "证件照背面",
        "hand": "上传手持证件照",
        "tip2": "请提供一张您手持证件照的照片，在同张照片中也要包含有“Tokenomy”、日期和您的签名的注释。请确保您的脸部清晰可见，且所有证件详细信息都清楚可读",
        "face": "面部清晰可见无遮挡",
        "clearly": "照片清晰可见",
        "notes": "带有[Tokenomy]的文字注释",
        ...
        "tip4": " 请提供一张您本人的Tokenomy账号的资产明细截图或者照片，图片中包含您的账户名、uid、持仓详情、当前时间。所有信息清晰可读。",
        "screenshot": "上传资产截图信息",
        "nowLever": "当前认证等级",
        "authCard": "身份证",
        "hu": "护照",
    ...
    "account": {
        ...
        "desc1": "本充值通路只支持加密货币的存款。 你用本国货币存款。 如果需要的話，请联系线上客服取得汇款账户"
    },
    "set": {
        "secset": "安全设置",
        "msgcer": "信息认证",
    ...
    "tpc": {
        ...
        "nodata": "暂无数据",
        "search": "搜索",
        "tips": "*当前页展示内容为项目方自行填写，Tokenomy不对此内容真实性负责",
        "time": "发行时间",
        "total": "发行总量",
        "circulation": "代币流通量",
        "price": "发行价",
    ...
    "bank": {
        ...
        "other": "别名",
        "branch": "銀行支行",
        "realfirst": "請先核實你的真實姓名！",
        "realauing": "您的實名認證正在稽核中!",
        "submit": "綁定銀行卡資訊",
        "reset": "Reset",
        "confirm": "綁定銀行卡資訊後，需要聯系線上客服進行修改。你確定要綁定嗎？",
        "change": "聯系線上客服進行修改",
        "withdraw":"提現到銀行卡",
        "withdrawTip":"如果您想在銀行卡上提取現金，請先綁定銀行卡資訊",
        "confirmwidthraw":"你確定要用銀行卡取現金嗎?",
        "binded":"您已經綁定了銀行卡，可以直接從銀行卡選取現金!",
        "contact":"想用銀行卡嗎？立即聯系線上客服購買"
    },
    "quantify":"AI量化",
    "LinkWallet":"链接钱包",
    "loanmum":"请填写需要贷款数的金额（最低）",
    "loanmax":"请填写需要贷款数的金额（最高）",
    "startApply":"开始申请",
    "minEmpty":"最低金额不能为空",
    "maxEmpty":"最高金额不能为空",
